...
var dt2 = require('./cadastro_dos_cliente');
var dt3 = require('./cadastro_dos_medico');
var dt4 = require('./login');
var dt5 = require('./planos');
var dt6 = require('./medicos');
var dt7 = require('./agendar_consultas');
var dt8 = require('./pagamentos');
var dt9 = require('./sobrenos');
var dt10 = require('./suporte');
var dt11 = require('./agendar');
var dt12 = require('./opçoes');
